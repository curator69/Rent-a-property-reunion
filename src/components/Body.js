    ...
    <>
      <div className="w-full md:w-[90vw] lg:w-full xl:w-[90vw] mx-auto p-5 rounded-lg bg-white">
        <div className="relative">
          ...
          <input
            type="Search"
            placeholder="Search by Location ,Bedrooms ,Bathrooms ,. . ."
            className="px-8 py-3 w-full rounded-md bg-orange-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm"
          />
        </div>
        {/* just a text filter */}
        <div className="flex items-center justify-between mt-4">
          ...
          <button
            ...
            className="px-4 py-2 bg-orange-100 hover:bg-orange-300 font-semibold text-gray-800 text-sm rounded-lg"
          >
            Reset Filter
          </button>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 mt-4">
            <select
              ...
              className="px-4 py-3 w-full font-semibold rounded-md bg-orange-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm"
            >
            ...
            <select
              ...
              className="px-4 py-3 font-semibold w-full rounded-md bg-orange-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm"
            >
      ...
      {info.length === 0 ? (
        <div className="mx-[42vw] font-bold text-xl w-40 my-6">
          No Data Found
        </div>
      ) : (
